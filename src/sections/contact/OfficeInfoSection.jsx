...
              <Typography sx={{ color: "#d6a53a", fontWeight: 600, letterSpacing: "0.16em", textTransform: "uppercase", mb: 2 }}>
                Get In Touch
              </Typography>
              <Typography sx={{ fontSize: { xs: "2rem", md: "2.8rem" }, fontWeight: 600, lineHeight: 1.08, mb: 5 }}>
...
              <LazyImage src={siteMedia.services.contactservice} alt="Four S Elevators maintenance support team in Pune" sx={{ width: "100%", height: "100%", objectFit: "cover", minHeight: { xs: 650, md: 300 } }} />
            </Box>
            
          
        {/* Bottom Cards Row */}
            <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", sm: "2fr 2fr",mt:"5" }, gap: 3 }}>
              
              {/* Phone Card */}
              <Reveal variant={fadeRight}>
                <Box sx={{ 
...
                  gap: 2,
                  transition: '0.3s',
                  '&:hover': { boxShadow: '0 15px 30px rgba(0,0,0,0.05)', transform: 'translateY(-5px)' }
                }}>
                  <Box sx={{ width: 48, height: 48, borderRadius: "12px", backgroundColor: alpha("#d6a53a", 0.1), color: "#d6a53a", display: "grid", placeItems: "center" }}>
                    <Phone fontSize="small" />
                  </Box>
                  <Box>
                    <Typography variant="caption" sx={{ fontWeight: 800, color: alpha("#102332", 0.5), textTransform: "uppercase", letterSpacing: "0.1em" }}>Call Us</Typography>
                    <Typography sx={{ fontWeight: 700, color: "#102332", fontSize: "0.95rem" }}>{companyProfile.phone[0]}</Typography>
                  </Box>
                </Box>
              </Reveal>
...
                  </Box>
                  <Box>
                    <Typography variant="caption" sx={{ fontWeight: 800, color: alpha("#102332", 0.5), textTransform: "uppercase", letterSpacing: "0.1em" }}>Email Us</Typography>
                    <Typography sx={{ fontWeight: 700, color: "#102332", fontSize: "0.95rem" }}>{companyProfile.email}</Typography>
                  </Box>
                </Box>
              </Reveal>
             
